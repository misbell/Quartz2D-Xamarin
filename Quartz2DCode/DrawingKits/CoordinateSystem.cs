...
namespace Quartz2DCode
{
	...
	//	void doRotatedEllipses(CGContextRef context) //
		void doRotatedEllipses()
		{
			...
			CGAffineTransform theTransform = CGAffineTransform.MakeRotation(Math.PI/4.0f);
			...
			context.TranslateCTM(100.0, 100.0);
			...
			for(i=0 ; i < totreps ; i++){
				...
				context.AddArc(0.0f, 0.0f, 45.0f, 0.0f, 2.0f * Math.PI, 0.0f);
